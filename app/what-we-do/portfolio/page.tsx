    ...
    <main className="min-h-screen bg-white font-poppins">
      ...
      <section className="bg-[#fdfcf9] py-10 sm:py-12 md:py-14">
        <div className="layout-7xl">
          <div className="text-[11px] uppercase tracking-[0.28em] text-[#8D1E39] font-medium">
            Investment Portfolio
          </div>
          <h2 className="mt-3 max-w-4xl font-[PPFONT] text-[1.7rem] sm:text-[2rem] leading-[1.45] tracking-[-0.01em] text-[#173053]">
            A disciplined portfolio built on <em className="italic">conviction,</em> not consensus.
          </h2>
          <p className="mt-4 max-w-4xl text-[16px] leading-[1.55] text-[#51617b]">
          ...
          <div className="mt-8 grid grid-cols-2 gap-3 sm:grid-cols-3 xl:grid-cols-6">
            {heroStats.map((stat) => (
              ...
              >
                ...
                <p className="mt-1 text-[11px] uppercase tracking-[0.08em] text-white/85">
                  {(stat.desc === "Manufacturing"
                    ? "5"
                    : stat.desc === "Agro"
                      ? "2"
