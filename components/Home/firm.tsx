    ...
    <section className="w-full min-h-screen bg-[#fdfcf9]">
      <div className="layout-7xl flex min-h-screen items-center py-6 sm:py-8 md:py-12 lg:py-16">
        <div className="max-w-[1180px]">
          ...
          <div className="mt-6 grid grid-cols-1 gap-6 sm:mt-8 sm:gap-8 lg:mt-12 lg:grid-cols-[0.8fr_1.2fr] lg:gap-8 xl:gap-10">
            ...
            <div className="space-y-5 sm:space-y-6 lg:col-start-2 lg:pl-8 xl:pl-14 lg:space-y-8">
              <p className="font-poppins text-[clamp(0.85rem,1vw,1.05rem)] leading-[1.6] text-[#5b5b5b]">
