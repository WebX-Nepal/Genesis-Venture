    ...
    <section className="relative overflow-hidden bg-white py-14 sm:py-16 lg:py-20">
      <div className="layout-7xl">
        <div className="grid grid-cols-1 items-end gap-4 border-b border-[#d8e2ee] pb-4 lg:grid-cols-2">
          <span className="inline-flex items-center justify-center gap-3 text-center font-montserrat text-[11px] sm:text-xs font-semibold uppercase tracking-[0.24em] text-[#173053] lg:justify-start lg:text-left">
            Investment Philosophy
          </span>
          <p className="text-center font-montserrat text-[11px] sm:text-xs uppercase tracking-[0.2em] text-[#4f6583] lg:text-right">
            Our Commitment
          </p>
        </div>
        <div className="mt-7 grid grid-cols-1 gap-8 lg:grid-cols-[1.1fr_0.9fr] lg:gap-10">
          <div className="rounded-sm border border-[#d8e2ee] bg-white p-6 text-center transition-all duration-300 hover:-translate-y-0.5 hover:shadow-[0_12px_28px_rgba(23,48,83,0.08)] sm:p-8">
            <h1 className="font-agatho text-[clamp(1.45rem,3.2vw,2.45rem)] leading-[1.2] text-[#173053]">
              Integrity before
              <span className="block text-[#8D1E39]">returns. Always.</span>
            </h1>
          ...
          <div className="rounded-sm border border-[#d8e2ee] bg-white p-6 text-center transition-all duration-300 hover:-translate-y-0.5 hover:shadow-[0_12px_28px_rgba(23,48,83,0.08)] sm:p-8">
            <span className="font-montserrat text-[11px] sm:text-xs font-semibold uppercase tracking-[0.18em] text-[#4f6583]">
              Statement
            </span>
